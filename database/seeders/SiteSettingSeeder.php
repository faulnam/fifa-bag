...
class SiteSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'announcement_text', 'value' => 'Gratis ongkir untuk pesanan di atas Rp 500.000 | Garansi uji coba 30 hari untuk semua tas & ransel | 100% Bahan Alami & Ramah Lingkungan | Pengiriman cepat ke seluruh Indonesia', 'group' => 'general'],
